        ...
        <div class="w-100">
            ...
            <div class="mb-3">
                ...
                <div class="row ms-1">
                    ...
                    <div class="form-check col-sm-4">
                        <input class="form-check-input" type="checkbox" value="{{ $position->id }}" wire:model.defer="position_ids.{{ $position->id }}" id="flexCheckPosition{{ $loop->index }}">
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" wire:model.defer="attendance.code" id="flexCheckCode">

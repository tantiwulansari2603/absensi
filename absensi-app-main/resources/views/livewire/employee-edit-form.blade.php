        ...
        @foreach ($employees as $employee)
            <div class="mb-3">
                <div class="w-100">
                    ...
                    <div class="mb-3">
                        <x-form-label id="password{{ $employee['id'] }}"
                            label='Password hanya bisa diubah oleh karyawaan' required="false" />
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="schools_id"
                            wire:model.defer="employees.{{ $loop->index }}.schools_id">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="locations_id"
                            wire:model.defer="employees.{{ $loop->index }}.locations_id">

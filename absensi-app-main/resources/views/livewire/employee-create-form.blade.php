                ...
                <div class="w-100">
                    ...
                    <div class="mb-3">
                        <x-form-label id="password{{ $i }}"
                            label='Password Karyawan {{ $i + 1 }} (default: "123" jika tidak diisi)'
                            required="false" />

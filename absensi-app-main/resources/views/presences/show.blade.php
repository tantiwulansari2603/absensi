                ...
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('presences.permissions', $attendance->id) }}" class="badge rounded-pill bg-info">Karyawaan
                            Izin</a>
                        <a href="{{ route('presences.not-present', $attendance->id) }}" class="badge rounded-pill bg-danger">Belum
                            Absen</a>
                        @if ($attendance->code)
                        <a href="{{ route('presences.qrcode', ['code' => $attendance->code]) }}" class="badge rounded-pill bg-success">QRCode</a>
                        @endif
                    </div>
                </div>

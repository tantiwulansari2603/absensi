                ...
                <div class="card o-hidden border-0">
                    <div class="bg-primary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0">Data Posisi</span>
                                <h4 class="mb-0 counter">{{ $positionCount }}</h4><i class="icon-bg" data-feather="database"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-secondary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0">Data User</span>
                                <h4 class="mb-0 counter">{{ $userCount }}</h4><i class="icon-bg" data-feather="user"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-primary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0">Data Kehadiran</span>
                                <h4 class="mb-0 counter">{{ $presenceCount }}</h4><i class="icon-bg" data-feather="message-circle"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-primary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body"><span class="m-0">Data Absensi</span>
                                <h4 class="mb-0 counter">{{ $attendanceCount }}</h4><i class="icon-bg" data-feather="user-plus"></i>
                            </div>
                        </div>
                    </div>
                </div>

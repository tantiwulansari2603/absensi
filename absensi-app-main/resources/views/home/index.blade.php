        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card shadow-sm mb-2">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            {{-- Loop untuk absensi yang memiliki lokasi yang sama --}}
                            @foreach ($datas['attendances'] as $attendance)
                                {{-- Periksa apakah lokasi absensi sama dengan lokasi pengguna yang login --}}
                                @if ($attendance->lokasi_id == auth()->user()->locations_id)
